...
/**
 * Autocomplete città (opzionale):
 * - Preferisce OpenWeather se `apiKey` presente, altrimenti fallback Open-Meteo geocoding.
 * - Emette `onSelect({ lat, lon, name })` e riempie l’input con il label scelto.
 */
